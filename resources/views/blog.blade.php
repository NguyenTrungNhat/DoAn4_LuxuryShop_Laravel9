                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="product-list-item">
                                                <div class="product-img img-zoom-effect">
                                                    <a href="single-product.html">
                                                        <img class="img-full" src="/webApp/assets/images/blog/small-size/1-1-86x86.jpg" alt="Blog Images">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-list-item">
                                                <div class="product-img img-zoom-effect">
                                                    <a href="single-product.html">
                                                        <img class="img-full" src="/webApp/assets/images/blog/small-size/1-2-86x86.jpg" alt="Blog Images">
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                                    <h5 class="title mb-3">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-list-item">
                                                <div class="product-img img-zoom-effect">
                                                    <a href="single-product.html">
                                                        <img class="img-full" src="/webApp/assets/images/blog/small-size/1-3-86x86.jpg" alt="Blog Images">
                                                    </a>
                                                </div>
                                                <div class="product-content">
                                                    <h5 class="title mb-3">
                            ...
                            <div class="blog-item row g-0">
                                <div class="col-md-6">
                                    <div class="blog-img img-zoom-effect h-100">
                                        <a href="blog-detail-left-sidebar.html">
                                            <img class="img-full h-100" src="/webApp/assets/images/blog/medium-size/1-1-370x315.jpg" alt="Blog Image">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="blog-item row g-0">
                                            <div class="col-md-6">
                                                <div class="blog-img img-zoom-effect h-100">
                                                    <a href="blog-detail-left-sidebar.html">
                                                        <img class="img-full h-100" src="/webApp/assets/images/blog/medium-size/1-3-370x315.jpg" alt="Blog Image">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="blog-item row g-0">
                                            <div class="col-md-6">
                                                <div class="blog-img img-zoom-effect h-100">
                                                    <a href="blog-detail-left-sidebar.html">
                                                        <img class="img-full h-100" src="/webApp/assets/images/blog/medium-size/1-2-370x315.jpg" alt="Blog Image">
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
