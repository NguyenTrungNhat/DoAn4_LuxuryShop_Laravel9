                                    ...
                                    <td class="quantity">
                                        ...
                                        <form action="{{ route('cart.update') }}" method="POST">
                                            ...
                                            <div class="">
                                                ...
                                                <input type="number" name="quantity" value="{{ $item->quantity }}" class="w-6 text-center bg-gray-300" style="width: 60px;" />
                                            </div>
                                            <button class="buttonCart" style="background-color: #010101;
                                                                                ...
                                                                                -o-transition: all 0.3s ease 0s;
                                                                                transition: all 0.3s ease 0s;
                                                                                width: inherit;" class="button mt-xxs-30">Update cart</button>
                                        </form>
                                    </td>
