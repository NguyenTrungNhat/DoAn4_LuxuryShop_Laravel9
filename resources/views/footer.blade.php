                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item">
                        <div class="footer-logo pb-4">
                            <a href="index.html">
                                <img src="/webApp/assets/images/logo/dark.png" alt="Logo">
                            </a>
                        </div>
                        ...
                        <div class="payment-method">
                            <a href="javascript:void(0)">
                                <img src="/webApp/assets/images/payment/1.png" alt="Payment Method">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-bottom py-3" data-bg-color="#bac34e">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright">
                        <span class="copyright-text text-white">© LuxuryShop buy NguyenTrungNhat <i class="fa fa-heart text-danger"></i> </span>
                    </div>
                </div>
            </div>
        </div>
